#!/usr/bin/env bash
# Run on VPS: bash deploy/fix-appareachart.sh
# Fixes AppAreaChart.tsx if it was corrupted by sed

set -e
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
TARGET="$REPO_ROOT/apps/admin/src/components/AppAreaChart.tsx"
