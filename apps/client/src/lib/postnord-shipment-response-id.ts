/**
 * Extract a parcel/shipment identifier usable with PostNord Track & Trace from
 * Shipping Module `complete-session`, Booking API `POST /v3/edi`, or similar JSON.
 *
 * @see PostNord Booking APIs 3.5.x — 201 response with `idInformation`, `bookingId`, etc.
 */
